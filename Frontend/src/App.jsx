...
const App = () => {
  return (
    <main className='min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 p-4 sm:p-10'>
      ...
      <div className='flex items-center justify-center sm:px-5 gap-x-1'>
        <Form />
